...
for zscore_computation = 1
    ...
    for control_computation = 1
        ...
        for T1_zscore = 1
            ...
            %% z-score
            T1_RI_IntCortical_z_cont         = zeros(NumIntSurf+2, vertexnum, size(case_num_cont, 1));
            T1_RI_SubCortical_z_cont         = zeros(NumSubSurf,   vertexnum, size(case_num_cont, 1));
            T1_PG_IntCortical_z_cont         = zeros(NumIntSurf+2, vertexnum, size(case_num_cont, 1));
            T1_PG_SubCortical_z_cont         = zeros(NumSubSurf,   vertexnum, size(case_num_cont, 1));
            T1_TG_IntCortical_z_cont         = zeros(NumIntSurf+2, vertexnum, size(case_num_cont, 1));
            T1_TG_SubCortical_z_cont         = zeros(NumSubSurf,   vertexnum, size(case_num_cont, 1));
            T1_CT_midCortical_z_cont         = zeros(size(case_num_cont, 1), vertexnum);
            T1_MC_midCortical_z_cont         = zeros(size(case_num_cont, 1), vertexnum);
            T1_SD_wmCortical_z_cont          = zeros(size(case_num_cont, 1), vertexnum);
            T1_PG_gw_IntCortical_z_cont      = zeros(size(case_num_cont, 1), vertexnum);
            ...
            for j = 1 : size(case_num_cont, 1)
                ...
                %% Intensity-based features: corrected RI, pg, tg
                T1_RI_IntCortical_z_cont(:, 1:vertexnum, j) = (T1_RI_IntCortical_temp(:, 1:vertexnum, j) - T1_RI_IntCortical_mean) ./ T1_RI_IntCortical_std;
                T1_PG_IntCortical_z_cont(:, 1:vertexnum, j) = (T1_PG_IntCortical_temp(:, 1:vertexnum, j) - T1_PG_IntCortical_mean) ./ T1_PG_IntCortical_std;
                T1_TG_IntCortical_z_cont(:, 1:vertexnum, j) = (T1_TG_IntCortical_temp(:, 1:vertexnum, j) - T1_TG_IntCortical_mean) ./ T1_TG_IntCortical_std;
                ...
                T1_TG_IntCortical_z_cont(isnan(T1_TG_IntCortical_z_cont)) = 0; T1_TG_IntCortical_z_cont(isinf(T1_TG_IntCortical_z_cont)) = 0;
                fprintf([ 'z-score of T1: RI_corrected, PG, TG in Inc, ' ]);
                
                %% Morphological / Intensity-based features: MC, SD, PG_GW
                T1_PG_gw_IntCortical_z_cont(j, 1:vertexnum) = (T1_PG_gw_IntCortical_temp(j, 1:vertexnum) - T1_PG_gw_IntCortical_mean) ./ T1_PG_gw_IntCortical_std;
                T1_CT_midCortical_z_cont(j, 1:vertexnum)    = (T1_CT_midCortical_temp(j, 1:vertexnum) - T1_CT_midCortical_mean) ./ T1_CT_midCortical_std;
                T1_MC_midCortical_z_cont(j, 1:vertexnum)    = (T1_MC_midCortical_temp(j, 1:vertexnum) - T1_MC_midCortical_mean) ./ T1_MC_midCortical_std;
                T1_SD_wmCortical_z_cont(j, 1:vertexnum)     = (T1_SD_wmCortical_temp(j, 1:vertexnum) - T1_SD_wmCortical_mean) ./ T1_SD_wmCortical_std;
                ...
                %% Intensity-based features of subcortical surfaces: RI, pg, tg
                T1_RI_SubCortical_z_cont(:, 1:vertexnum, j) = (T1_RI_SubCortical_temp(:, 1:vertexnum, j) - T1_RI_SubCortical_mean) ./ T1_RI_SubCortical_std;
                T1_PG_SubCortical_z_cont(:, 1:vertexnum, j) = (T1_PG_SubCortical_temp(:, 1:vertexnum, j) - T1_PG_SubCortical_mean) ./ T1_PG_SubCortical_std;
                T1_TG_SubCortical_z_cont(:, 1:vertexnum, j) = (T1_TG_SubCortical_temp(:, 1:vertexnum, j) - T1_TG_SubCortical_mean) ./ T1_TG_SubCortical_std;
            ...
            T1_RI_IntCortical_z_cont(:, :, logical(outlier_vector)) = [];
            T1_RI_SubCortical_z_cont(:, :, logical(outlier_vector)) = [];
            T1_PG_IntCortical_z_cont(:, :, logical(outlier_vector)) = [];
            T1_PG_SubCortical_z_cont(:, :, logical(outlier_vector)) = [];
            T1_TG_IntCortical_z_cont(:, :, logical(outlier_vector)) = [];
            T1_TG_SubCortical_z_cont(:, :, logical(outlier_vector)) = [];
            T1_CT_midCortical_z_cont(logical(outlier_vector), :) = [];
            T1_MC_midCortical_z_cont(logical(outlier_vector), :) = [];
            T1_SD_wmCortical_z_cont(logical(outlier_vector), :) = [];
            T1_PG_gw_IntCortical_z_cont(logical(outlier_vector), :) = [];
        ...
        for FLAIR_zscore = 1
            ...
            FLAIR_RI_IntCortical_z_cont         = zeros(NumIntSurf+2, vertexnum, size(case_num_cont, 1));
            FLAIR_RI_SubCortical_z_cont         = zeros(NumSubSurf,   vertexnum, size(case_num_cont, 1));
            FLAIR_PG_IntCortical_z_cont         = zeros(NumIntSurf+2, vertexnum, size(case_num_cont, 1));
            FLAIR_PG_SubCortical_z_cont         = zeros(NumSubSurf,   vertexnum, size(case_num_cont, 1));
            FLAIR_TG_IntCortical_z_cont         = zeros(NumIntSurf+2, vertexnum, size(case_num_cont, 1));
            FLAIR_TG_SubCortical_z_cont         = zeros(NumSubSurf,   vertexnum, size(case_num_cont, 1));
            FLAIR_PG_gw_IntCortical_z_cont      = zeros(size(case_num_cont, 1), vertexnum);
            ...
            for j = 1 : size(case_num_cont, 1)
                ...
                %% Intensity-based features: corrected RI, pg, tg
                FLAIR_RI_IntCortical_z_cont(:, 1:vertexnum, j) = (FLAIR_RI_IntCortical_temp(:, 1:vertexnum, j) - FLAIR_RI_IntCortical_mean) ./ FLAIR_RI_IntCortical_std;
                FLAIR_PG_IntCortical_z_cont(:, 1:vertexnum, j) = (FLAIR_PG_IntCortical_temp(:, 1:vertexnum, j) - FLAIR_PG_IntCortical_mean) ./ FLAIR_PG_IntCortical_std;
                FLAIR_TG_IntCortical_z_cont(:, 1:vertexnum, j) = (FLAIR_TG_IntCortical_temp(:, 1:vertexnum, j) - FLAIR_TG_IntCortical_mean) ./ FLAIR_TG_IntCortical_std;
                ...
                %% Morphological / Intensity-based features: MC, SD, PG_GW
                FLAIR_PG_gw_IntCortical_z_cont(j, 1:vertexnum) = (FLAIR_PG_gw_IntCortical_temp(j, 1:vertexnum) - FLAIR_PG_gw_IntCortical_mean) ./ FLAIR_PG_gw_IntCortical_std;
                FLAIR_PG_gw_IntCortical_z_cont(isnan(FLAIR_PG_gw_IntCortical_z_cont)) = 0;
                fprintf([ 'PG_gw in Inc, ' ]);
                
                %% Intensity-based features of subcortical surfaces: RI, pg, tg
                FLAIR_RI_SubCortical_z_cont(:, 1:vertexnum, j) = (FLAIR_RI_SubCortical_temp(:, 1:vertexnum, j) - FLAIR_RI_SubCortical_mean) ./ FLAIR_RI_SubCortical_std;
                FLAIR_PG_SubCortical_z_cont(:, 1:vertexnum, j) = (FLAIR_PG_SubCortical_temp(:, 1:vertexnum, j) - FLAIR_PG_SubCortical_mean) ./ FLAIR_PG_SubCortical_std;
                FLAIR_TG_SubCortical_z_cont(:, 1:vertexnum, j) = (FLAIR_TG_SubCortical_temp(:, 1:vertexnum, j) - FLAIR_TG_SubCortical_mean) ./ FLAIR_TG_SubCortical_std;
            ...
            FLAIR_RI_IntCortical_z_cont(:, :, logical(outlier_vector)) = [];
            FLAIR_RI_SubCortical_z_cont(:, :, logical(outlier_vector)) = [];
            FLAIR_PG_IntCortical_z_cont(:, :, logical(outlier_vector)) = [];
            FLAIR_PG_SubCortical_z_cont(:, :, logical(outlier_vector)) = [];
            FLAIR_TG_IntCortical_z_cont(:, :, logical(outlier_vector)) = [];
            FLAIR_TG_SubCortical_z_cont(:, :, logical(outlier_vector)) = [];
            FLAIR_PG_gw_IntCortical_z_cont(logical(outlier_vector), :) = [];
            
        end
        
        % save zscore as a mat file
        for save_zscore = 1
            if(~exist([ 'zscore_database_perilesional_T1_FLAIR_sm_' num2str(Kernel) '_cont.mat'], 'file'))
                save( [ 'zscore_database_perilesional_T1_FLAIR_sm_' num2str(Kernel) '_cont.mat'], ...
                    'T1_RI_IntCortical_z_cont', ...
                    'T1_PG_IntCortical_z_cont', ...
                    'T1_PG_gw_IntCortical_z_cont', ...
                    'T1_TG_IntCortical_z_cont', ...
                    'T1_RI_SubCortical_z_cont', ...
                    'T1_CT_midCortical_z_cont', ...
                    'T1_MC_midCortical_z_cont', ...
                    'T1_SD_wmCortical_z_cont', ...
                    'FLAIR_RI_IntCortical_z_cont', ...
                    'FLAIR_PG_IntCortical_z_cont', ...
                    'FLAIR_PG_gw_IntCortical_z_cont', ...
                    'FLAIR_TG_IntCortical_z_cont', ...
                    'FLAIR_RI_SubCortical_z_cont');
            end
        end
    ...
    for patient_computation = 1
        ...
        for T1_zscore = 1
            ...
            for j = 1 : size(case_num_pat, 1)
                ...
                T1_TG_IntCortical_z(isnan(T1_TG_IntCortical_z)) = 0; T1_TG_IntCortical_z(isinf(T1_TG_IntCortical_z)) = 0;
                fprintf([ 'z-score of T1: RI_corrected, PG, TG in Inc, ' ]);
        ...
        % save zscore as a mat file
        for save_zscore = 1
            if(~exist([ 'zscore_database_perilesional_T1_FLAIR_sm_' num2str(Kernel) '.mat'], 'file'))
                save( [ 'zscore_database_perilesional_T1_FLAIR_sm_' num2str(Kernel) '.mat'], ...
                    'T1_RI_IntCortical_z', ...
                    'T1_PG_IntCortical_z', ...
