...
for j = 1 : size(contrast_str, 2)
    ...
    if(exist([ output_dir case_num '/measurement/' case_prefix '_' case_num '_white_surface_' num2str(subcortical_surface_number) '_' left_right '_' num2str(nummesh) postfix_surf  postfix_contrast '.txt' ], 'file') ~= 0 && overwrite ~= 1)
