...
for read_demodata_setup_params = 1
    ...
    Group_pat                 = 'FCD'
    Prefix_pat                = 'mcd'
    Cases_cont                = '/host/gypsy/local_raid/seokjun/01_project/04_IntracorticalAnalysis/01_analysis/Demographic_data_control_DTI.txt'
    Cases_pat                 = '/host/gypsy/local_raid/seokjun/01_project/04_IntracorticalAnalysis/01_analysis/Demographic_data_FCD_DTI.txt'
...
for profile_analyses = 1
    ...
    for separation_analysis_by_histo_types = 1
        ...
        FCD_IIa = strncmp(histo_type, 'FCDIIa', 6)'; % FCD_IIa(22) = 0; FCD_IIa(27) = 0;
        ...
        include = ones(size(case_num_pat_temp, 1), 1);
        p_type_IIa_vs_IIb_1_left  = [];
        p_type_IIa_vs_IIb_1_right = [];
        for i = 1 : length(feature_set_idx)
            [p_temp,h,stats] = ranksum(mean(mean_z_lesion(feature_set_idx{i}, FCD_IIa), 1), mean(mean_z_lesion(feature_set_idx{i}, FCD_IIb), 1), 'tail', 'left');
            p_type_IIa_vs_IIb_1_left = [ p_type_IIa_vs_IIb_1_left p_temp ];
            [p_temp,h,stats] = ranksum(mean(mean_z_lesion(feature_set_idx{i}, FCD_IIa), 1), mean(mean_z_lesion(feature_set_idx{i}, FCD_IIb), 1), 'tail', 'right');
            p_type_IIa_vs_IIb_1_right = [ p_type_IIa_vs_IIb_1_right p_temp ];
        end
        
        p_type_IIa_vs_IIb_1_2 = min([p_type_IIa_vs_IIb_1_left; p_type_IIa_vs_IIb_1_right], [], 1);
    ...
    for GM_WM_wise_separation_analysis_by_histo_types = 1
        ...
        p_type_IIa_vs_IIb_2_1 = min([p_type_IIa_vs_IIb_1_left; p_type_IIa_vs_IIb_1_right], [], 1);
