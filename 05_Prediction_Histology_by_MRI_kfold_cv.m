...
for t1_flair_dti_fMRI = 1
    ...
    for prediction_using_multimodal_depth_features = 1
        ...
        for all_modalities_together = 1
            ...
            for i = 1 : iteration_num
                ...
                for c = 1 : kfold
                    ...
                    elseif(bagging_num>0)
                        ...
                        prediction_curr(test_cases) = mode(cell2mat(test_bagging), 2) == strcmp(CV_group_test, 'FCDIIa');
            ...
            % result
            % 10-fold validation with bagging    : 85±6% -> 96% (majority voting)
            % Average performance of each set of folds is 85±6%. 
            % On the other hand, if we perform a majory voting strategy (treshold: 0.5), we reached a consensus classification of 96% (22/23, one TypeIIX, being consistently misclassified).
        ...
        for all_features_including_perilesional_ab = 1
            ...
            % result
            % 10-fold validation with bagging    : 88±8%
            % 10-fold validation without bagging : 85±7%
            % leave-one-out with bagging         : 93±5%
            % leave-one-out without bagging      : 95%
